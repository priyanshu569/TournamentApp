                ...
                <TouchableOpacity activeOpacity={linked ? 0.85 : 1} onPress={() => goToProfile(item)} disabled={!linked}>
                  ...
                  >
                    ...
                    <View style={[styles.avatarWrap, !linked && styles.avatarWrapUnlinked]}>
                      <Avatar avatarId={item.avatar_id} frameId={item.avatar_frame} avatarUrl={item.avatar_url} username={item.username} size={34} />
                    </View>
                    <View style={{ flex: 1 }}>
...
function getStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    gameChipText: { color: colors.textTertiary, fontSize: 12, fontWeight: '600' },
    ...
    row: {
      ...
      padding: 16, marginBottom: 10, borderWidth: 1, borderColor: colors.borderMuted,
    },
    podiumRow: {
      flexDirection: 'row', alignItems: 'center',
    ...
    statLabel: { color: colors.textFaint, fontSize: 9, fontWeight: '700', marginTop: 2 },
    pointsValue: { color: colors.warning },
  });
}

...
function getStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    // paddingHorizontal/paddingVertical on `bubble` are more specific
    // than a generic `padding: 0` here and win regardless of style
    // array order -- must zero the exact same keys to actually clear it.
    bubbleImage: { paddingHorizontal: 0, paddingVertical: 0, overflow: 'hidden', borderWidth: 0 },
